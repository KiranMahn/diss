...
%% Susan:
%% Replace Mars with MARS?
%% Replace MARS' with MARS
%% Replace better fit with best fit?
...
%% Susan: 
%% You switch back and forth between past tense and present tense in this next paragraph: choose one or the other and be consistent throughout!
%% Replace apple app store with Apple App Store
...
%% Susan: 
%% The transition from reviewing existing work to setting project direction is a little abrupt here.
%% Suggest you start a new subsection here e.g. Project Direction
\subsection{Project Direction}

%% Then I suggest you reorder the text below, as I've shown here...
%% Splitting the last paragraph into two, inserting the software dev approach in the middle
%% Then setting the objective, ready for going into specification and design next...

%% Susan: 
%% Alternative phrasing: Given the issues identified above, this project aims... 
...
%% Susan: 
%% This paragraph needs an introduction, since it's a different topic from the last one 
%% e.g. In order to decide what software development framework to use when developing this app, two common Agile frameworks were considered: Scrum and Kanban.
...
%% Susan: 
%% Now state which one you actually chose? 
