...
%% Susan: 
%% Update to: without informing the user or by misleading the user
%% beacuse > because
%% persons > person's
%% microsoft > Microsoft
%% User interviews are > User interviews were
...
%% Susan
%% color > colour  (unless your advisor is American!)
...
%% Susan: 
%% caption: Structure User Data is Stored in AsyncStorage > Structure of User Data Stored in AsyncStorage
  \begin{table}[h!!]
