...
%% Susan: 
%% oppertunities for the uers > opportunities for the users
...
%% Susan: 
%% with text stated that > with text that stated that
...
%% Susan: 
%% Along with tracking > There were additional questions tracking 
...
%% Susan: 
%% Suggest you drop this section.
%% Move ref to incarceration to Background:Project Direction
%% Move last sentence from "the goal of this project" onwards 
%% to be the first sentence under Functional Requirements, 
%% as a reminder of overall goal before launching into the details of the requirements.
% \subsection{Analysis}
...
%% json > JSON
%% 
%% The quotes around the word symptoms did not display as you intended. 
%% Try using two single quote marks on either side like this instead: ``symptoms''
%% 
